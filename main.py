...
if __name__ == "__main__":
    ...
    for day_time_key in tqdm(speech_data['daytime'].keys()):
        day_time_data = speech_data['daytime'][day_time_key]
        for play_name in day_time_data.keys():
            
            Player_content = day_time_data[play_name][0]
            day_time_data[play_name]=  {}
            day_time_data[play_name]['content']=  Player_content
            score = analyze_game_text(Player_content)
            day_time_data[play_name]['score']=  score
    print(speech_data)
